...
/**
 * Resolve a path (e.g. "morlds/unformed-deep/index.html") to a full URL
 * so it works on GitHub Pages and locally. On GitHub Pages, if the site is
 * opened without a trailing slash, relative paths break (404).
 */
